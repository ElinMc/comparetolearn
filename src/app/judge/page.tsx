    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full mx-4 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Amazing work!</h1>
          <p className="text-gray-600 mb-4">
            You&apos;ve completed all {judgementsCount} comparisons for this task.
          </p>
          <p className="text-sm text-gray-500 mb-6">
            Each comparison helped build your understanding of what quality looks like.
          </p>
          <Link
            href="/judge"
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <div className="text-sm text-gray-500">Comparisons made</div>
              <div className="text-xl font-bold text-purple-600">{judgementsCount}</div>
            </div>
          </div>
        </div>
        {/* Criteria Bar */}
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          {selected && (
            <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Why did you choose this one? <span className="text-gray-400">(optional but helpful!)</span>
              </label>
              <textarea
                value={reasoning}
                ...
                rows={3}
                placeholder="What made this one better? Think about the success criteria..."
              />
              <button
                onClick={submitJudgement}
                className="mt-4 w-full px-6 py-3 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition-colors"
              >
